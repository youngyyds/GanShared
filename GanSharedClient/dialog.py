    ...
    def __init__(self, master,
        ...
        for num in range(len(buttons)):
            ...
            b = Button(self.frame, text=s,
                       command=(lambda self=self, num=num: self.done(num)), takefocus=False)
            if num == default:
...
class Dialog(Toplevel):
    ...
    def buttonbox(self):
        ...
        w = Button(box, text="OK", width=10, command=self.ok, default=ACTIVE, takefocus=False)
        w.pack(side=LEFT, padx=5, pady=5)
        w = Button(box, text="Cancel", width=10, command=self.cancel, takefocus=False)
        w.pack(side=LEFT, padx=5, pady=5)
...
class _QueryDialog(Dialog):
    ...
    def validate(self):
        ...
        if self.other != None and result is self.other:
            self.result = result
